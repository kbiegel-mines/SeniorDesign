...
def totalWeighting(distance, count, data):
...
for i in range(current+1, totalCount):
    distance = createDistance(current_x, current_y, distance)
    weight = totalWeighting(distance, count, data)
    current_x, current_y = newPoint(current_x, current_y, weight)
